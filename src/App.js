...
const LogoutModal = () => {
  return (
    <div classNameName="modal fade" id="logoutModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div classNameName="modal-dialog" role="document">
        <div classNameName="modal-content">
          <div classNameName="modal-header">
            <h5 classNameName="modal-title" id="exampleModalLabel">Ready to Leave?</h5>
            <button classNameName="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div classNameName="modal-body">Select "Logout" below if you are ready to end your current session.</div>
          <div classNameName="modal-footer">
            <button classNameName="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a classNameName="btn btn-primary" href="login.html">Logout</a>
          </div>
        </div>
      </div>
    </div>);}
